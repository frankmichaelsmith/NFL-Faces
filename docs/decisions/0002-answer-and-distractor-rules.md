...
- **Alumni weighting:** each distractor slot independently draws from the alumni pool (QBs who led the rolled team in another season) with probability `ALUMNI_PROB` = 0.6, else at random. Frank wants a mix, not all-alumni every round.
